...
public class BrightnessFilter extends PhotoFilter {
    ...
    */
    public int transformPixel(int inPixel) {
        int red = constrain(Color.red(inPixel) + SeekBarState.getInstance().getBrightnessDelta());
        int green = constrain(Color.green(inPixel) + SeekBarState.getInstance().getBrightnessDelta());
        int blue = constrain(Color.blue(inPixel) + SeekBarState.getInstance().getBrightnessDelta());
