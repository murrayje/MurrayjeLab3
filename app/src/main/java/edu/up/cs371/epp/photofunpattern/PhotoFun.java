...
public class PhotoFun extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeekBar brightnessFilterSeekBar = (SeekBar) findViewById(R.id.brightnessFilterSeekBar);
        brightnessFilterSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener()
        {
            public void onProgressChanged(SeekBar brightnessFilterSeekBar, int progress, boolean fromUser)
            {
            ...
            public void onStartTrackingTouch(SeekBar brightnessFilterSeekBar)
            {

            }
            public void onStopTrackingTouch(SeekBar brightnessFilterSeekBar)
            {
